import { faBath, faBed, faDog, faCar } from "@fortawesome/free-solid-svg-icons"
...
export const PropertyFeatures = () => {
    ...
    return (
        <div className="max-w-lg mx-auto my-10 p-5 bg-white text-slate-900">
            ...
            <h3 className="text-5xl font-bold text-center">£{numeral(propertyFeatures.price).format("0,0")}</h3>
        </div>
    )
}